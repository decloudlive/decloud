...
start_master_application(Config) ->
	...
	ok = application:set_env(decloud, config, ApplicationConfig),
...
start_slave_application(Config, ApplicationConfig) ->
	...
	ok = ct_rpc:call(Slave, application, set_env, [decloud, config, ApplicationConfig]),
