...
%%% A collection of record structures used throughout the decloud server.

%% How nodes identify they are on the same network.
-ifndef(NETWORK_NAME).
-define(NETWORK_NAME, "decloud.N.1").
-endif.

%% Current release number of the decloud client software.
