...
-define(MANIFEST_CONTENT_TYPE, <<"application/x.decloud-manifest+json">>).
...
%%     triggers a TXT record lookup at _decloud.custom.domain.example
...
handle_custom_request_2(CustomDomain, Path, Req, Env) ->
	case ar_domain:lookup_decloud_txt_record(CustomDomain) of
		not_found ->
