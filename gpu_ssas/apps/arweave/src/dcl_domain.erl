...
-export([get_labeling/3, lookup_decloud_txt_record/1, derive_tx_label/2]).
...
lookup_decloud_txt_record(Domain) ->
	case inet_res:lookup("_decloud." ++ binary_to_list(Domain), in, txt) of
		[] ->
			not_found;
		[RecordChunks|_] ->
