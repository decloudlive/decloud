...
namespace DCLCore.ApplicationState
{
    public class VersionState : NotifyChangedBase
    {
        ...
        public const string UpdaterUrlTemplate = "https://github.com/Decloud/Decloud/releases/download/{VERSION_TAG}/DCL_windows_updater_{VERSION_TAG}.exe";
        public const string ZipUrlTemplate = "https://github.com/Decloud/Decloud/releases/download/{VERSION_TAG}/DCL_windows_{VERSION_TAG}.zip";

        //public const string UpdaterUrlTemplate = "https://github.com/Decloud/Decloud3Alpha/releases/download/{VERSION_TAG}/DCL_windows_updater_{VERSION_TAG}.exe";
        //public const string ZipUrlTemplate = "https://github.com/Decloud/Decloud3Alpha/releases/download/{VERSION_TAG}/DCL_windows_{VERSION_TAG}.zip";
