...
namespace DCLCore
{
    static partial class ApplicationStateManager
    {
        ...
        public static string Title
        {
            get
            {
                return $"{DCLProductInfo.Name} v" + Application.ProductVersion + BetaAlphaPostfixString + BuildTagStr;
            }
        }
        #endregion BuildTag
        ...
        public static async Task BeforeExit()
        {
            ...
            try
            {
                ...
                waitTasks.Add(DecloudPluginsManager.RunninLoops);
        ...
        public static bool SystemRequirementsEnsured()
        {
            ...
            {
                MessageBox.Show(Tr("{0} requires .NET Framework 4.5 or higher to work properly. Please install Microsoft .NET Framework 4.5", DCLProductInfo.Name),
                    Tr("Warning!"),
            ...
            {
                MessageBox.Show(Tr("{0} supports only x64 platforms. You will not be able to use {0} with x86", DCLProductInfo.Name),
                    Tr("Warning!"),
                    MessageBoxButtons.OK);
