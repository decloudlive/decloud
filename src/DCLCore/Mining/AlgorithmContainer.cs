...
namespace DCLCore.Mining
{
    public class AlgorithmContainer : NotifyChangedBase
    {
        ...
        {
            if (nameof(DCLCore.Mining.ComputeDevice.State) == e.PropertyName)
            {
        ...
        /// <summary>
        /// Friendly name for this algorithm/Decloud combo
        /// </summary>
        ...
        public string DecloudUUID => Algorithm?.DecloudID;
