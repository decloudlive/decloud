...
namespace DCLCore.Mining.Benchmarking
{
    internal class BenchmarkingAnalyzer
    {
        ...
        /// </summary>
        private static int DeviantCap => (60 / Configs.MiningSettings.Instance.DecloudAPIQueryInterval) * 3;
        ...
        /// </summary>
        private static int MaxHistory => (MaxHistoryTimeRangeInMinutes * 60) / Configs.MiningSettings.Instance.DecloudAPIQueryInterval;
