...
namespace DCLCore.Mining.Grouping
{
    public static class GroupingUtils
    {
        ...
        {
            // must be from the same plugin container instance (same Decloud binary)
        ...
        {
            // Group compatible mining pairs into Decloud.
            // #1 mining pairs are compatible if they use the same Decloud binary (same Plugin/Decloud UUID + Version)
            ...
            // The less Decloud instances we have the better.
