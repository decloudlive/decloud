...
namespace DCLCore.Mining.Plugins
{
    ...
    public class PluginPackageInfoCR : NotifyChangedBase
    {
        public PluginPackageInfoCR(string pluginUUID)
        {
            ...
            try
            {
                IsAutoUpdateEnabled = !File.Exists(Paths.DecloudPluginsPath(pluginUUID, "disable_autoupdates"));
            }
            catch (Exception e)
            {
        ...
        private void CommonOnPropertyChanged()
        {
            ...
            OnPropertyChanged(nameof(DecloudPackageURL));
        ...
        public bool CompatibleNHPluginVersion
        {
            get
            {
                ...
                var isNHPlugin = "info@Decloud.com" == OnlineInfo?.PluginAuthor;
        ...
        public string DecloudPackageURL
        {
            get
            {
                //var DecloudURL = LocalInfo?.DecloudPackageURL ?? OnlineInfo?.DecloudPackageURL ?? "N/A";
                var DecloudURL = OnlineInfo?.DecloudPackageURL ?? "N/A";
                return DecloudURL;
            }
        }
        ...
        public bool IsAutoUpdateEnabled
        {
            ...
            set
            {
                ...
                try
                {
                    var disableAutoUpdatesFile = Paths.DecloudPluginsPath(PluginUUID, "disable_autoupdates");
                    if (value)
                    {
