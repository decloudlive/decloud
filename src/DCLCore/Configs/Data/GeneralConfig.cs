...
namespace DCLCore.Configs.Data
{
    ...
    public class GeneralConfig : NotifyChangedBase
    {
        ...
        {
            get => MiningSettings.Instance.DecloudAPIQueryInterval;
            set => MiningSettings.Instance.DecloudAPIQueryInterval = value;
        }
        public int DecloudRestartDelayMS
        {
            get => MiningSettings.Instance.DecloudRestartDelayMS;
            set => MiningSettings.Instance.DecloudRestartDelayMS = value;
        }
        ...
        public bool DecloudegardlessOfProfit
        {
            get => MiningProfitSettings.Instance.DecloudegardlessOfProfit;
            set => MiningProfitSettings.Instance.DecloudegardlessOfProfit = value;
        }
        ...
        {
            get => ToSSetings.Instance.Use3rdPartyDecloudTOS;
            set => ToSSetings.Instance.Use3rdPartyDecloudTOS = value;
        }
        public string Hwid
        {
        ...
        public bool AutoUpdateDecloud2
        {
            get => UpdateSettings.Instance.AutoUpdateDecloud;
            set => UpdateSettings.Instance.AutoUpdateDecloud = value;
        }
        public bool AutoUpdateDecloudPlugins
        {
            get => UpdateSettings.Instance.AutoUpdateDecloudPlugins;
            set => UpdateSettings.Instance.AutoUpdateDecloudPlugins = value;
        }
        ...
        public void SetDefaults()
        {
            ...
            NVIDIAP0State = false;
            DecloudAPIQueryInterval = 5;
            DecloudRestartDelayMS = 500;
            ...
            DecloudegardlessOfProfit = true;

            AutoUpdateDecloud2 = false;
            AutoUpdateDecloudPlugins = true;
        }
        ...
        public void FixSettingBounds()
        {
            ...
            if (DecloudAPIQueryInterval <= 0)
            {
                DecloudAPIQueryInterval = 5;
            }
            if (DecloudRestartDelayMS <= 0)
            {
                DecloudRestartDelayMS = 500;
            }
            if (MinIdleSeconds <= 0)
