...
namespace Decloud.ViewModels.Plugins
{
    public class PluginEntryVM : BaseVM
    {
        ...
        {
            DecloudPluginsManager.InstallRemoveProgress(Plugin.PluginUUID, Progress);
        }
        ...
        protected PluginEntryVM(PluginPackageInfoCR plugin, LoadProgress load)
        {
            ...
            Progress = new Progress<Tuple<PluginInstallProgressState, int>>(status =>
            {
                ...
                switch (state)
                {
                    ...
                    case PluginInstallProgressState.DownloadingDecloud:
                        statusText = Tr("Downloading Decloud: {0}%", progress);
                        break;
                    ...
                    case PluginInstallProgressState.ExtractingDecloud:
                        statusText = Tr("Extracting Decloud: {0}%", progress);
                        break;
            ...
            DecloudPluginsManager.InstallAddProgress(plugin.PluginUUID, Progress);
        }
        ...
        public async Task InstallOrUpdatePlugin()
        {
            ...
            await DecloudPluginsManager.DownloadAndInstall(Plugin.PluginUUID, Progress, CancellationToken.None);
            CommonInstallOnPropertyChanged();
        }
        ...
        public async Task UninstallPlugin()
        {
            ...
            await DecloudPluginsManager.RemovePlugin(Plugin.PluginUUID);
        ...
        {
            var pluginPath = Paths.DecloudPluginsPath(Plugin.PluginUUID);
