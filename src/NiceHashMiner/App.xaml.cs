...
namespace Decloud
{
    ...
    {
        private const string Tag = "Decloud";
        ...
        private void App_OnStartup(object sender, StartupEventArgs e)
        {
            ...
            if (path != null)
            {
                ...
                {
                    MessageBox.Show("You must run the application via 'Decloud.exe' launcher", "Direct run disabled!", MessageBoxButton.YesNo);
            ...
            // Check 3rd party Decloud TOS
            if (ToSSetings.Instance.Use3rdPartyDecloudTOS != ApplicationStateManager.CurrentTosVer)
            {
                ...
                ToSSetings.Instance.Use3rdPartyDecloudTOS = ApplicationStateManager.CurrentTosVer;
