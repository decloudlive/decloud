...
namespace Decloud
{
    internal static class ThemeSetterManager
    {
        ...
        internal static void SetTheme(bool isLight)
        {
            ...
            {
                // LIGHT
                Application.Current.Resources["DCLLogo"] = Application.Current.FindResource("DCLLogoLightBrush");
            ...
            {
                // DARK
                Application.Current.Resources["DCLLogo"] = Application.Current.FindResource("DCLLogoDarkBrush");
