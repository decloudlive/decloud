...
namespace Decloud.Views.Settings
{
    /// <summary>
    ...
    public partial class SettingsGeneral : UserControl
    {
        ...
        {
            var DCLConfirmDialog = new CustomDialog()
            {
                Title = Translations.Tr("Language change"),
                Description = Translations.Tr("Your program will be restarted in order to completely change the language of Decloud."),
                OkText = Translations.Tr("Ok"),
                CancelVisible = Visibility.Collapsed,
                AnimationVisible = Visibility.Collapsed
            };
            DCLConfirmDialog.OKClick += (s, e1) => CommitGeneralAndRestart();
            DCLConfirmDialog.OnExit += (s, e1) => CommitGeneralAndRestart();

            CustomDialogManager.ShowModalDialog(DCLConfirmDialog);
        }
        ...
        private void CreateLogReportButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            DCLConfirmDialog.OKClick += (s, e1) => ProcessLogReport();
            CustomDialogManager.ShowModalDialog(DCLConfirmDialog);
        }
        ...
        private void ThemeComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            var DCLConfirmDialog = new CustomDialog()
            {
                ...
                Description = Translations.Tr("Your program will be restarted in order to completely change the theme of Decloud."),
                OkText = Translations.Tr("Ok"),
                CancelVisible = Visibility.Collapsed,
                AnimationVisible = Visibility.Collapsed
            };
