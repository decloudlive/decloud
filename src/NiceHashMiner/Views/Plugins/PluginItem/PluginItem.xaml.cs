...
namespace Decloud.Views.Plugins.PluginItem
{
    /// <summary>
        ...
        private async void Button_Click_Install(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                var dialog = new CustomDialog(400, 300)
                {
                    ...
                    Description = "Decloud integrates 3rd party mining software via the Decloud plugin system. However, since this is 3rd party software that is fully closed-source, we have no chance to inspect it in any way. Decloud can not vouch for using that software and is refusing to take any responsibility for any damage caused, security breaches, loss of data or funds, system or hardware error, and other issues. By agreeing to this disclaimer you take full responsibility for using these closed-source Decloud as they are.",
                    OkText = Tr("I ACCEPT"),
