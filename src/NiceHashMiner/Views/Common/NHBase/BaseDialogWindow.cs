...
using Decloud.Views.Common.NHBase.Utils;
using System;
...
namespace Decloud.Views.Common.NHBase
{
    public partial class BaseDialogWindow : Window, IThemeSetter
    {
        ...
        public Grid DCLIcon { get; private set; }
        ...
        public override void OnApplyTemplate()
        {
            ...
            DCLIcon = this.GetRequiredTemplateChild<Grid>("DCLIcon");
        ...
        {
            if (DCLIcon != null) DCLIcon.Visibility = Visibility.Hidden;
