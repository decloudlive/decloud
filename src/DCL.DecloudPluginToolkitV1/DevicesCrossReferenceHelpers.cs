...
namespace DCL.DecloudPluginToolkitV1
{
    ...
    {
        /// <summary>
        /// DecloudOutput creates new process and gets its StandardOutput
        /// </summary>
        public static async Task<string> DecloudOutput(string path, string arguments, int timeoutMilliseconds = 30 * 1000)
        {
            string output = "";
            try
            {
            ...
            {
                Logger.Error("DevicesCrossReferenceHelpers", $"Error occured while getting Decloud output: {e.Message}");
                return "";
            }
            return output;
        }
...
#warning DO NOT DELETE THIS function old plugins rely on IT!
        ...
        /// DecloudOutput creates new process and gets its StandardOutput
        /// </summary>
        public static async Task<string> DecloudOutput(string path, string arguments, IEnumerable<string> breakLines, int timeoutMilliseconds = 30 * 1000)
        {
