...
{
    [Serializable]
    public class DecloudApiMaxTimeoutSetting : IInternalSetting
    {
        ...
        public static TimeSpan ParseMaxTimeout(TimeSpan defaultMaxTimeout, DecloudApiMaxTimeoutSetting config, IEnumerable<MiningPair> miningPairs)
        {
        ...
        public static bool ParseIsEnabled(bool defaultValue, DecloudApiMaxTimeoutSetting config)
        {
            if (config?.UseUserSettings ?? false)
            {
