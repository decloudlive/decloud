...
{
    public class DecloudBenchmarkTimeSettings : IInternalSetting
    {
        ...
        public static int ParseBenchmarkTime(List<int> defaults, DecloudBenchmarkTimeSettings timeSetting, IEnumerable<MiningPair> miningPairs, BenchmarkPerformanceType benchmarkType)
        {
        ...
        public static int ParseBenchmarkTime(Dictionary<BenchmarkPerformanceType, int> defaults, DecloudBenchmarkTimeSettings timeSetting, IEnumerable<MiningPair> miningPairs, BenchmarkPerformanceType benchmarkType)
        {
            try
            {
        ...
        public static int ParseBenchmarkTicks(List<int> defaults, DecloudBenchmarkTimeSettings timeSetting, IEnumerable<MiningPair> miningPairs, BenchmarkPerformanceType benchmarkType)
        {
            var dict = new Dictionary<BenchmarkPerformanceType, int> {
                {BenchmarkPerformanceType.Quick, defaults[0] },
                {BenchmarkPerformanceType.Standard, defaults[1] },
        ...
        public static int ParseBenchmarkTicks(Dictionary<BenchmarkPerformanceType, int> defaults, DecloudBenchmarkTimeSettings timeSetting, IEnumerable<MiningPair> miningPairs, BenchmarkPerformanceType benchmarkType)
        {
            try
            {
                if (timeSetting?.UseUserSettings ?? false)
