...
namespace DCL.DecloudPluginToolkitV1.ClaymoreCommon
{

    public abstract class ClaymoreBase : DecloudBase
    {
...
#pragma warning restore 0618
        ...
        {
            var urlFirst = StratumServiceHelpers.GetLocationUrl(_algorithmType, _miningLocation, DCLConectionType.STRATUM_TCP);
            var cmd = "";
            ...
            {
                var urlSecond = StratumServiceHelpers.GetLocationUrl(_algorithmSecondType, _miningLocation, DCLConectionType.STRATUM_TCP);
