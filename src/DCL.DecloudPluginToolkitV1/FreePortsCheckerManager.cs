...
{
    /// <summary>
    /// FreePortsCheckerManager class is checking reserved ports for Decloud (<see cref="DecloudBase"/>).
    /// It is integrated with Decloud and client. User can specify ports for each algorithm.
    /// </summary>
