    ...
    internal static class PluginInternalSettings
    {
        internal static DecloudOptionsPackage DecloudOptionsPackage = new DecloudOptionsPackage
        {
            GeneralOptions = new List<DecloudOption> {
                /// <summary>
                /// Turn on AMD compute mode on the supported GPUs. This is equivalent of pressing 'y' in the Decloud console.
                /// </summary>
                new DecloudOption
                {
                ...
                /// <summary>
                /// Set the GPU tuning parameter (6 to 400). The default is 15. You can change the tuning parameter interactively with the '+' and '-' keys in the Decloud's console window.
                /// You may specify this option per-GPU. If you don't specify -gt or you specify value 0, the Decloud will use auto-tuning to determine the best GT value.
                ...
                /// You can change the this parameter interactively with the '+' and '-' keys in the Decloud's console window. You may specify this option per-GPU.
                /// If you set -sci to 0, the Decloud will use auto-tuning to determine the best value, while trying to maximize the ethash hashrate regardless of the secondary coin hashrate.
                /// </summary>
                new DecloudOption
                {
                    Type = DecloudOptionType.OptionWithMultipleParameters,
                ...
                /// <summary>
                /// Restart the Decloud if avg 5 min speed is below <n> MH/s
                /// </summary>
                new DecloudOption
                {
                ...
                /// <summary>
                /// Restart the Decloud when allocating buffer for a new DAG epoch.
                /// The possible values are: 0 - never, 1 - always, 2 - auto (the Decloud decides depending on the driver version).
                ...
                /// replaced by the current date/time to create a unique name every time PhoenixDecloud is started.
                /// If there is no asterisk in the logfile name, the new log entries will be added to end of the same file.
                /// If you want to use the same logfile but the contents to be overwritten every time when you start the Decloud,
                ...
                /// <summary>
                /// Do not reset overclocking settings when closing the Decloud
                /// </summary>
                new DecloudOption
                {
                    Type = DecloudOptionType.OptionIsParameter,
                ...
                /// increasingly aggressive settings). If you want to fine tune the value, you may run the Decloud with "-rxboost 1", write down the
                ...
                /// If specified the Decloud will calculate the rig daily electricity cost
                /// </summary>
                new DecloudOption
                {
                    Type = DecloudOptionType.OptionWithSingleParameter,
        ...
        {
            // we have same env vars for all Decloud now, check avemore env vars if they differ and use custom env vars instead of defaults
