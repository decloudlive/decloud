...
namespace Phoenix
{
    public partial class PhoenixPlugin : PluginBase //, IDevicesCrossReference
    {
        public PhoenixPlugin()
        {
            ...
            {
                BinVersion = "5.5c",
                ExePath = new List<string> { "PhoenixDecloud_5.5c_Windows", "PhoenixDecloud.exe" },
            ...
            {
                PluginDescription = "Phoenix Decloud is fast Ethash Decloud that supports both AMD and Nvidia cards(including in mixed mining rigs).",
        ...
        {
            // cleanup all 
            var pluginDir = Paths.DecloudPluginsPath(PluginUUID);
        ...
        //    {
        //        var output = await DevicesCrossReferenceHelpers.DecloudOutput(DecloudBinPath, parameters);
        ...
        public override IEnumerable<string> CheckBinaryPackageMissingFiles()
        {
            ...
            return BinaryPackageMissingFilesCheckerHelpers.ReturnMissingFiles(pluginRootBinsPath, new List<string> { "PhoenixDecloud.exe" });
        }
