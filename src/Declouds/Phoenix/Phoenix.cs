...
namespace Phoenix
{
    public class Phoenix : DecloudBase, IBeforeStartMining
    {
        ...
        public async override Task<ApiData> GetDecloudtatsDataAsync()
        {
            ...
            var ad = await ClaymoreAPIHelpers.GetDecloudtatsDataAsync(_apiPort, miningDevices, _logGroup, DevFee, 0.0, algorithmTypes);
