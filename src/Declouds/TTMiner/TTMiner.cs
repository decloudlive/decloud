...
using DCL.DecloudPluginToolkitV1.ClaymoreCommon;
...
namespace TTDecloud
{
    public class TTDecloud : DecloudBase, IAfterStartMining
    {
        ...
        public TTDecloud(string uuid, Dictionary<string, int> mappedDeviceIds) : base(uuid)
        {
        ...
        public async override Task<ApiData> GetDecloudtatsDataAsync()
        {
            ...
            return await ClaymoreAPIHelpers.GetDecloudtatsDataAsync(_apiPort, miningDevices, _logGroup, DevFee, 0.0, algorithmTypes);
        }
