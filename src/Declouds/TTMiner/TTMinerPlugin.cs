...
namespace TTDecloud
{
    public partial class TTDecloudPlugin : PluginBase, IDevicesCrossReference
    {
        public TTDecloudPlugin()
        {
            // mandatory init
            ...
            {
                BinVersion = "4.0.3",
                ExePath = new List<string> { "TT-Decloud.exe" },
                Urls = new List<string>
                {
                    "https://tradeproject.de/download/Decloud/TT-Decloud-4.0.3.zip" // original
                }
            };
            PluginMetaInfo = new PluginMetaInfo
            {
                PluginDescription = "TT-Decloud is mining software for NVIDIA devices.",
        ...
        public override string Name => "TTDecloud";
        ...
        {
            return new TTDecloud(PluginUUID, _mappedDeviceIds);
        }
        ...
        public override Dictionary<BaseDevice, IReadOnlyList<Algorithm>> GetSupportedAlgorithms(IEnumerable<BaseDevice> devices)
        {
            ...
            {
                _mappedDeviceIds[gpu.UUID] = gpu.ID; //lazy init -> TT-Decloud sorts devices as we do
        ...
        public async Task DevicesCrossReference(IEnumerable<BaseDevice> devices)
        {
            ...
            var output = await DevicesCrossReferenceHelpers.DecloudOutput(DecloudBinPath, "-list");
            var mappedDevs = DevicesListParser.ParseTTDecloudOutput(output, devices.ToList());
