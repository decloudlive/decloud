...
namespace TeamRedDecloud
{
    ...
    {
        public static Dictionary<string, int> ParseTeamRedDecloudOutput(string output, List<BaseDevice> baseDevices)
        {
            ...
            if (lines.Count() != 0)
            {
                foreach (var line in lines)
                {
                    ...
                    int.TryParse(DecloudID, out var ID);
