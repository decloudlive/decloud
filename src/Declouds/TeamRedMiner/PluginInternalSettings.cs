...
namespace TeamRedDecloud
{
    ...
    {
        internal static DecloudystemEnvironmentVariables DecloudystemEnvironmentVariables = new DecloudystemEnvironmentVariables
        {
        ...
        internal static DecloudOptionsPackage DecloudOptionsPackage = new DecloudOptionsPackage
        {
            GeneralOptions = new List<DecloudOption>
            {
                ...
                {
                    Type = DecloudOptionType.OptionWithSingleParameter,
                    ID = "teamRedDecloud_logInterval",
                    ShortName = "-l",
                    LongName = "--log_interval="
                },
                /// <summary>
                /// Enables logging of Decloud output into the file specified by FILENAME.
                /// If no filename is provided, the Decloud will log to trm_<algo>_<yyyymmdd_hhmmss>.log in the current working directory.
                /// If the log file already exists, the Decloud will append.
                /// </summary>
                new DecloudOption
                {
                    Type = DecloudOptionType.OptionWithSingleParameter,
                    ID = "teamRedDecloud_logFile",
                    ShortName = "--log_file="
                },
                /// <summary>
                ...
                {
                    Type = DecloudOptionType.OptionIsParameter,
                    ID = "teamRedDecloud_enableCompute",
                    ShortName = "--enable_compute"
                },
                /// <summary>
                /// Manual cryptonight configuration for the Decloud.  CONFIG must be in the form
                ...
                /// mode which can be either '.', -', '+' or '*'.  Mode '.' means that the Decloud
                ...
                {
                    Type = DecloudOptionType.OptionWithSingleParameter,
                    ID = "teamRedDecloud_noInterleave",
                ...
                {
                    Type = DecloudOptionType.OptionWithSingleParameter,
                    ID = "teamRedDecloud_autoTuneMode",
                    ShortName = "--auto_tune=",
                    DefaultValue = "QUICK"
                },
                /// <summary>
                ...
                /// explicit nr of runs or let the Decloud choose a default value per gpu type (typically 3-4).
                /// </summary>
                new DecloudOption
                {
                    Type = DecloudOptionType.OptionWithSingleParameter,
                    ID = "teamRedDecloud_autoTuneRuns",
                    ShortName = "--auto_tune_runs=",
                },
                /// <summary>
                /// If present, and when the driver indicates there is enough GPU vram available, the Decloud
                ...
                {
                    Type = DecloudOptionType.OptionIsParameter,
                    ID = "teamRedDecloud_ethAggrMode",
                    ShortName = "--eth_aggr_mode",
                },
                /// <summary>
                ///  anual ethash configuration for the Decloud.  CONFIG must be in the form [M][L].
                ...
                {
                    Type = DecloudOptionType.OptionWithMultipleParameters,
                    ID = "teamRedDecloud_ethConfig",
                    ShortName = "--eth_config=",
                },
                /// <summary>
                ///  Configures the gpu watchdog to shut down the Decloud and run the specified platform
                ...
                {
                    Type = DecloudOptionType.OptionIsParameter,
                    ID = "teamRedDecloud_watchdogScriptDefault",
                    ShortName = "--watchdog_script",
                },
                new DecloudOption
                {
                    Type = DecloudOptionType.OptionWithSingleParameter,
                    ID = "teamRedDecloud_watchdogScript",
                    ShortName = "--watchdog_script=",
                },
                /// <summary>
                ...
                {
                    Type = DecloudOptionType.OptionIsParameter,
                    ID = "teamRedDecloud_watchdogTest",
                ...
                {
                    Type = DecloudOptionType.OptionIsParameter,
                    ID = "teamRedDecloud_watchdogDisabled",
                    ShortName = "--watchdog_disabled",
                },
                /// <summary>
                ///  On Windows, the allocation balance is very delicate for 4GB gpus being able to reach their
                ///  maximum possible DAG epoch.  The Decloud uses a strategy that has worked fine for our test gpus,
                ...
                {
                    Type = DecloudOptionType.OptionWithMultipleParameters,
                    ID = "teamRedDecloud_4gAllocAdjust",
            ...
            {
                /// <summary>
                ///  Sets the temperature at which the Decloud will stop GPUs that are too hot.
                ///  Default is 85C.
                /// </summary>
                new DecloudOption
                {
                    Type = DecloudOptionType.OptionWithSingleParameter,
                    ID = "teamRedDecloud_tempLimit",
                    ShortName = "--temp_limit=",
                    DefaultValue = "85"
                },
                /// <summary>
                ///  Sets the temperature below which the Decloud will resume GPUs that were previously stopped due to temperature exceeding limit.
                ///  Default is 60C.
                /// </summary>
                new DecloudOption
                {
                    Type = DecloudOptionType.OptionWithSingleParameter,
                    ID = "teamRedDecloud_tempResume",
