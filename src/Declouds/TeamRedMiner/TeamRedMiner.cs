...
using static DCL.Common.StratumServiceHelpers;

namespace TeamRedDecloud
{
    public class TeamRedDecloud : DecloudBase
    {
        ...
        public TeamRedDecloud(string uuid) : base(uuid)
        {
        }
        ...
        private string CreateCommandLine(string username)
        {
            ...
            var url = GetLocationUrl(_algorithmType, _miningLocation, DCLConectionType.STRATUM_TCP);
        ...
        protected override void Init()
        {
            ...
            var openClAmdPlatformResult = DecloudToolkit.GetOpenCLPlatformID(_miningPairs);
            ...
            {
                Logger.Error(_logGroup, "Initialization of Decloud failed. Multiple OpenCLPlatform IDs found!");
