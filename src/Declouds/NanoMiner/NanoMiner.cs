...
{
    public class NanoDecloud : DecloudBase
    {
        ...
        public NanoDecloud(string uuid, Dictionary<string, int> mappedIDs) : base(uuid)
        {
        ...
        private string CreateCommandLine(string username)
        {
            ...
            var url = StratumServiceHelpers.GetLocationUrl(_algorithmType, _miningLocation, DCLConectionType.NONE);
