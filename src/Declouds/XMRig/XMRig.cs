...
namespace XMRig
{
    public class XMRig : DecloudBase, IBeforeStartMining
    {
        // TODO DevFee 
        ...
        private string CreateCommandLine(string username)
        {
            ...
            {
                cmd = $"-a {AlgoName} -o {urlWithPort} -u {username} --http-enabled --http-port={_apiPort} --Decloud {_extraLaunchParameters}";
            }
