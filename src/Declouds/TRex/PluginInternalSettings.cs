    ...
    internal static class PluginInternalSettings
    {
        ...
        internal static DecloudOptionsPackage DecloudOptionsPackage = new DecloudOptionsPackage
        {
            GeneralOptions = new List<DecloudOption>
            {
                ...
                /// Set to 0 to enable auto-tuning: the Decloud will benchmark each kernel and select the fastest.
                ...
                /// <summary>
                /// Forces Decloud to immediately reconnect to pool on N successively failed shares (default: 10).
                /// </summary>
                new DecloudOption
                {
                    Type = DecloudOptionType.OptionWithSingleParameter,
                ...
                /// Requires running the Decloud with administrative privileges.
                /// Can be set to a comma separated list to apply different values to different cards.
                ...
                ///  0 - auto (Decloud will choose the most appropriate mode based on the GPU model)
                ...
                /// <summary>
                /// Executes user script right after Decloud start (eg: --script-start path_to_user_script)
                /// </summary>
                new DecloudOption
                {
                    Type = DecloudOptionType.OptionWithSingleParameter,
                ...
                /// <summary>
                /// Executes user script in case of Decloud crash.
                /// </summary>
                new DecloudOption
                {
                    Type = DecloudOptionType.OptionWithSingleParameter,
                ...
                /// <summary>
                /// Executes user script right before Decloud exit.
                /// </summary>
                new DecloudOption
                {
                    Type = DecloudOptionType.OptionWithSingleParameter,
