...
LangString cleanInstallKeep ${LANG_ENGLISH} "Keep the old settings (this will keep backups, configs, internals and Decloud_plugins)"
LangString cleanInstallCleanup ${LANG_ENGLISH} "Clean installation (removes all user settings and Decloud files)"
